...
begin
    ...
    begin
        try
           ...
           item := lb_icone.ItemByIndex(0); //LAURO                    // item:TListBoxItem; variável criada logo a cima, //lb_icone = nome dado a ListBox no formulário // ItemByIndex = busca no item o indice ( faz parte do comando )
