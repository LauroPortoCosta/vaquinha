     ...
     try
       ...
       Result := va_05_dm.DM.FDQuery_lancamento2;
        ...
        begin
            Active := false;
            sql.Clear;
            sql.Add('SELECT *');                                          //  um BUG com os centavos , acrescentou o (CAST .... AS REAL) para resolver o problema
