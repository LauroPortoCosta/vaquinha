...
begin
    ...
    begin
       ...
       case StrToIntDef(resp, 0) of
         ...
         1: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageA2.Bitmap;
         2: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageA3.Bitmap;
         3: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageA4.Bitmap;
         4: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageB1.Bitmap;
         5: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageB2.Bitmap;
         6: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageB3.Bitmap;
         7: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageB4.Bitmap;
         8: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageC1.Bitmap;
         9: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageC2.Bitmap;
        10: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageC3.Bitmap;
        11: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageC4.Bitmap;
        12: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageD1.Bitmap;
        13: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageD2.Bitmap;
        14: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageD3.Bitmap;
        15: TListItemImage(Objects.FindDrawable('ImgIcone')).Bitmap := ImageD4.Bitmap;
       else
