...
begin
    try
        ...
        // Valores     //#FF487DF7 AZUL
        chart.ShowValues := true;
        chart.FontSizeValues := 12;
        chart.FontColorValues := $FF999999;// CINZA MUITO CLARO
        chart.FormatValues := '#,##0.00';

        // Barras
        //chart.BarColor := $FFFFD270; // AMARELO
        //chart.ShowBackground := true;
        //chart.BackgroundColor := $FF4F5060; // CINZA UM POUCO MAIS ESCURO                                  $FF7DACEF
        ...
        chart.FontColorArgument := $FF878787; // CINZA CLARO
...
begin
    try
        ...
        // Valores   //#FF487DF7  -> AUZL
        chart.ShowValues := true;
        chart.FontSizeValues := 12;
        chart.FontColorValues := $FF999999; // CINZA CLARO
        chart.FormatValues := '#,##0.00';

        // Barras
        //chart.BarColor := $FFFFD270; // AMARELO
        //chart.ShowBackground := true;
        //chart.BackgroundColor := $FF4F5060; // CINZA ESCURO
        //chart.RoundedBotton := true;
        //chart.RoundedTop := true;
        chart.LineColor := $FFFFD270; // AMARELO
